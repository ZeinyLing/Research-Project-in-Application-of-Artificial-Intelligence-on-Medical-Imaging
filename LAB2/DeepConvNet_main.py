...
def plot_train_acc(train_acc_list, epochs):
    ...
    plt.savefig("./plots/leakyRELU_EP1000EP1000_DP_train_accuracy.png", dpi=300)
    plt.close()
...
def plot_train_loss(train_loss_list, epochs):
    ...
    plt.tight_layout()
    os.makedirs("./plots", exist_ok=True)
    plt.savefig("./plots/leakyRELU_EP1000EP1000_DP_train_loss.png", dpi=300)
    plt.close()
...
def plot_test_acc(test_acc_list, epochs):
    ...
    plt.tight_layout()
    os.makedirs("./plots", exist_ok=True)
    plt.savefig("./plots/leakyRELU_EP1000EP1000_DP_test_accuracy.png", dpi=300)
    plt.close()
...
def plot_test_loss(test_loss_list, epochs):
    ...
    plt.tight_layout()
    os.makedirs("./plots", exist_ok=True)
    plt.savefig("./plots/leakyRELU_EP1000EP1000_DP_test_loss.png", dpi=300)
    plt.close()
...
def train(model, loader, criterion, optimizer, args, test_loader, device):
    ...
    torch.save(best_wts, "./weights/leakyRELU_EP1000EP1000_DP__best.pt")
...
if __name__ == '__main__':
    ...
    # === Model ===
    model = DeepConvNet(num_classes=2, channels=2, samples=750).to(device)
